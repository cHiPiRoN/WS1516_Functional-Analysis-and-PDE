	...
	\section{$L^p$ spaces - Lebesgue integral}\label{c2se4}
		...
		\begin{definition}\label{c2se4def27}
			...
			\begin{itemize}
				...
				\item This is no normed space. Therefore set an equivalence relation $\texttildelow$: $f\tilde{g}$ iff $f=g$ $\mu$-a.e. Using this we define
				\[
		...
		\end{definition}
		\begin{remark} 
			$f\tilde g$ implies that $\|f\|_p = \|g\|_p$ and therefore $\|[f]\|_p = \|[g]\|_p$.
		\end{remark}
		...
		\begin{theorem}\label{c2se4thm30}
 		...
 		\begin{remark}
 			The convolution is symmetric: $f*g = g*f$. Moreover, if $f=\tilde{f}$ a.e. and $g=\tilde{g}$ a.e. it holds that 
 			\[
 				f*g = \tilde{f} * \tilde{g},\quad\forall x.
 			\]
 		\end{remark}
